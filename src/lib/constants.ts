export const CLIENT = {
  ...
  stats: [
    { value: '180K', label: 'Instagram followers' },
    { value: '95K', label: 'YouTube subscribers' },
    { value: '5+', label: 'Years on keto' },
  ],
}

export const BOOK = {
  title: '30-Day Keto Reset',
  subtitle: 'Your complete guide to effortless keto living',
  price: '$27',
  gumroadUrl: '#buy',
  features: [
    { icon: 'book', text: '80+ hand-tested keto recipes' },
    { icon: 'calendar', text: '4-week structured meal plan' },
    { icon: 'list', text: 'Weekly grocery shopping lists' },
    { icon: 'calculator', text: 'Macros & portions cheat sheet' },
    { icon: 'clock', text: '10 emergency recipes (under 15 min)' },
    { icon: 'cake', text: '12 guilt-free keto desserts' },
  ],
...
export const TESTIMONIALS = [
  {
    ...
    avatar: 'SM',
    rating: 5,
    text: 'Lost 12 kg in 30 days following this exactly. The recipes are genuinely delicious — my husband steals my leftovers!',
  },
  {
    name: 'Mia T.',
    age: 28,
...
export const FAQ = [
  ...
  },
  {
    ...
    a: 'Absolutely. The book starts with a clear "Keto 101" primer that explains everything from scratch — macros, what to eat, what to skip, and how to navigate social situations.',
  },
  {
    q: 'Do I need special or expensive ingredients?',
